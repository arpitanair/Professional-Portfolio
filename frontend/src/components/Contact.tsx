...
export function Contact() {
  return (
    <section id="contact" className="scroll-mt-24 border-t border-line/50 py-20 lg:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        <Reveal delay={0.08}>
          <p className="mt-8 font-mono text-[11px] uppercase tracking-[0.3em] text-mist">
        ...
        <Reveal delay={0.14}>
          <h2
            ...
            className="mt-6 font-display text-[clamp(2.3rem,7vw,6.2rem)] leading-[0.98] tracking-tight text-ivory"
          >
            LET'S TURN DATA
            <br />
          ...
          {links.map((l, i) => (
            <Reveal key={l.label} delay={0.1 + i * 0.06}>
              <a
                ...
                className="group flex items-center justify-between gap-6 border-t border-line/60 py-5 transition-colors duration-300 last:border-b hover:border-cobalt/40 lg:py-7"
              >
                <div className="flex flex-col gap-1.5 sm:flex-row sm:items-baseline sm:gap-6">
                  <span className="font-display text-xl text-ivory transition-colors duration-300 group-hover:text-cobalt-soft sm:text-2xl lg:text-3xl">
                    {l.label}
                  </span>
